...
public class Indicators extends javax.swing.JFrame {
    ...
    public Indicators(PrintWriter out) {
        initComponents();
        send=out;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String mes=jTextField1.getText()+" "+jTextField2.getText()+" "+jTextField3.getText()+" "+jTextField4.getText()+"\n";
        send.println(mes);
